...
<body>
    <div class="container">
        ...
        <div class="exam-header">
            <h1 class="exam-title">{{ $exam->ExamTitle }}</h1>
            ...
            <div class="exam-meta">
                <div class="meta-item">
                    ...
                    <div class="meta-value">{{ $exam->company->CompanyName ?? 'N/A' }}</div>
                </div>
                <div class="meta-item">
                    <div class="meta-label">Position</div>
                    <div class="meta-value">{{ $exam->job->JobTitle ?? 'N/A' }}</div>
                </div>
                <div class="meta-item">
                    <div class="meta-label">Duration</div>
                    <div class="meta-value">{{ gmdate('H:i', $exam->Duration) }} minutes</div>
                </div>
                <div class="meta-item">
                    <div class="meta-label">Questions</div>
                    <div class="meta-value">{{ $questions->count() }}</div>
                </div>
                <div class="meta-item">
        ...
        <div class="timer" id="timer">
            ...
            <span id="timeRemaining">{{ gmdate('H:i:s', $exam->Duration) }}</span>
        </div>

        <form id="examForm" method="POST" action="{{ route('exam.submit', ['scheduleId' => $attempt->ScheduleID]) }}">
            @csrf
            <div class="exam-form">
                ...
                <div class="question-container">
                    <div class="question-header">
                        ...
                        <span class="question-difficulty">{{ ucfirst($question->Difficulty) }}</span>
                    </div>
                    
                    <div class="question-text">
                        {{-- Remove any "(Question X)" text if exists --}}
                        {{ preg_replace('/\s*\(Question\s+\d+\)\s*$/', '', $question->QuestionText) }}
                    </div>
    ...
    <script>
        // Timer functionality
        let timeRemaining = {{ $exam->Duration }}; // in seconds
